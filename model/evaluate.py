...
llama_70b_model = AutoModelForCausalLM.from_pretrained('meta-llama/Llama-3-70B-Instruct')
llama_8b_model = AutoModelForCausalLM.from_pretrained('meta-llama/Meta-Llama-3-8B-Instruct')

llama_70b_tokenizer = AutoTokenizer.from_pretrained('meta-llama/Llama-3-70B-Instruct')
